...
$price_bottom_output                = $capture_subscription_details_hook( 'pms_view_meta_box_subscription_details_price_bottom' );
$sign_up_fee_bottom_output          = $capture_subscription_details_hook( 'pms_view_meta_box_subscription_details_sign_up_fee_bottom' );
$free_trial_bottom_output           = $capture_subscription_details_hook( 'pms_view_meta_box_subscription_details_free_trial_bottom' );
$payment_installments_bottom_output = $capture_subscription_details_hook( 'pms_view_meta_box_subscription_details_payment_installments_bottom' );
$renewal_bottom_output              = $capture_subscription_details_hook( 'pms_view_meta_box_subscription_details_renewal_bottom' );

// Exit if accessed directly
if ( ! defined( 'ABSPATH' ) ) exit;
?>
<?php do_action( 'pms_subscription_plan_price_top', $subscription_plan->id ); ?>
...
<div class="pms-meta-box-field-wrapper cozmoslabs-form-field-wrapper">
    ...
    <span class="pms-input-with-suffix">
        <input type="text" id="pms-subscription-plan-price" name="pms_subscription_plan_price" class="small" value="<?php echo esc_attr( $subscription_plan->price ); ?>" />
        <span class="pms-input-suffix" id="pms-default-currency"><?php echo esc_html( pms_get_active_currency() ); ?></span>
    </span>

    <p class="cozmoslabs-description cozmoslabs-description-space-left"><?php esc_html_e( 'Amount you want to charge people who join this plan. Leave 0 if you want this plan to be free.', 'paid-member-subscriptions' ); ?></p>
</div>

<?php echo $price_bottom_output; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>

<?php if ( pms_payment_gateways_support( pms_get_active_payment_gateways(), 'subscription_sign_up_fee' ) ) : ?>
    <div class="pms-meta-box-field-wrapper cozmoslabs-form-field-wrapper">
        <span class="pms-form-label-with-docs">
        ...
        <span class="pms-input-with-suffix">
            <input type="text" id="pms-subscription-plan-sign-up-fee" name="pms_subscription_plan_sign_up_fee" class="small" value="<?php echo esc_attr( $subscription_plan->sign_up_fee ); ?>" />
            <span class="pms-input-suffix"><?php echo esc_html( pms_get_active_currency() ); ?></span>
        </span>

        <p class="cozmoslabs-description cozmoslabs-description-space-left"><?php esc_html_e( 'Amount you want to charge people upfront when subscribing to this plan.', 'paid-member-subscriptions' ); ?></p>
    </div>

    <?php echo $sign_up_fee_bottom_output; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
<?php endif; ?>
...
<?php if ( pms_payment_gateways_support( pms_get_active_payment_gateways(), 'subscription_free_trial' ) ) : ?>
    <div class="pms-meta-box-field-wrapper cozmoslabs-form-field-wrapper">
        ...
        <p class="cozmoslabs-description cozmoslabs-description-space-left"><?php esc_html_e( 'The free trial represents the amount of time before charging the first recurring payment. The sign-up fee applies regardless of the free trial.', 'paid-member-subscriptions' ); ?></p>
    </div>

    <?php echo $free_trial_bottom_output; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
<?php endif; ?>
    ...
    <div id="payment-cycles">
        <div class="pms-meta-box-field-wrapper cozmoslabs-form-field-wrapper cozmoslabs-toggle-switch">
            ...
            <div class="cozmoslabs-toggle-description">
                <label for="pms-limit-payment-cycles" class="cozmoslabs-description"><?php esc_html_e( 'Enable', 'paid-member-subscriptions' ); ?></label>
            </div>

            <p class="cozmoslabs-description cozmoslabs-description-space-left"><?php esc_html_e( 'Enable this option to let customers pay in installments.', 'paid-member-subscriptions' ); ?></p>
        </div>
        ...
        <?php echo $payment_installments_bottom_output; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
    </div>
<?php endif; ?>
...
<?php if ( pms_payment_gateways_support( pms_get_active_payment_gateways(), 'recurring_payments' ) ) : ?>
    <div class="pms-meta-box-field-wrapper cozmoslabs-form-field-wrapper" id="pms-subscription-plan-renewal-option-field">
        ...
        <p class="cozmoslabs-description cozmoslabs-description-space-left" id="pms-renewal-description"><?php esc_html_e( 'Select renewal type. You can either allow the customer to opt in, force automatic renewal or force no renewal.', 'paid-member-subscriptions' ); ?></p>

        <?php pms_output_billing_cycles_renewal_message( $subscription_plan ); ?>
    </div>

    <?php echo $renewal_bottom_output; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
<?php endif; ?>

<?php do_action( 'pms_subscription_plan_price_bottom', $subscription_plan->id ); ?>
